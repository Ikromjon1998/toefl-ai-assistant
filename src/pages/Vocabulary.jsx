...
const getRandomWord = (sampleWords, knownWords, unknownWords) => {
  const availableWords = sampleWords.filter(
    word => !knownWords.includes(word) && !unknownWords.includes(word)
  );
...
const PageHeader = () => (
  <div className='text-center mb-8'>
    ...
    <p className='text-gray-600 max-w-2xl mx-auto'>
      Learn and review TOEFL vocabulary with flashcards, word lookup, and
      progress tracking.
    </p>
  </div>
);
...
const WordLookupSection = ({ onLookup, isLoading, error, definition }) => (
  <div className='card'>
    <h2 className='text-xl font-semibold text-gray-900 mb-4'>Word Lookup</h2>
  ...
  return (
    <div className='card'>
      ...
      <div className='text-center py-8'>
        ...
        {!definition ? (
          <button onClick={onReveal} className='btn-primary mb-4'>
            Reveal Definition
          </button>
        ) : (
          <div className='mb-6'>
...
const FlashcardControls = ({ onStartFlashcard, onClearProgress, hasWords }) => (
  <div className='card'>
    <h2 className='text-xl font-semibold text-gray-900 mb-4'>Flashcard Mode</h2>
    ...
    <div className='space-y-4'>
      ...
      <button onClick={onClearProgress} className='btn-secondary w-full'>
        Clear All Progress
      </button>
    </div>
    ...
    {!hasWords && (
      <p className='text-sm text-gray-500 mt-2 text-center'>
        No words available for flashcards. Try marking some words as
        known/unknown first.
      </p>
    )}
  </div>
...
const Vocabulary = () => {
  ...
  const hasAvailableWords =
    getRandomWord(SAMPLE_WORDS, knownWords, unknownWords) !== null;
