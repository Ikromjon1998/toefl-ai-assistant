...
const PageHeader = () => (
  <div className='text-center mb-8'>
    ...
    <p className='text-gray-600 max-w-2xl mx-auto'>
      Write an essay and get AI-powered feedback with detailed scoring, grammar
...
const EssayTextarea = ({ essay, onEssayChange, wordCount, isLoading }) => (
  <div className='mb-4'>
    ...
    <div className='flex justify-between items-center mt-2'>
      ...
      <span className='text-sm text-gray-500'>{essay.length} characters</span>
    </div>
  </div>
);
...
const FeedbackLoadingState = () => (
  <div className='text-center py-8'>
    ...
    <p className='text-sm text-gray-500'>
      Generating detailed feedback with AI
    </p>
  </div>
);
...
const Writing = () => {
  ...
  const handleSubmit = async e => {
    ...
    try {
      ...
      setError(
        'Failed to get feedback. Please check your API key and try again.'
      );
