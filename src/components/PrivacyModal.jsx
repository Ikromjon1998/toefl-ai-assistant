          ...
          <div className="text-sm text-gray-600 space-y-4">
            ...
            <section>
              ...
              <ul className="list-disc list-inside ml-4 space-y-1">
                <li>Essay content and writing samples you submit for feedback</li>
            ...
            <section>
              ...
              <ul className="list-disc list-inside ml-4 space-y-1">
                ...
                <li>Not shared with third parties except as required for service provision</li>
            ...
            <section>
              ...
              <p>We use essential cookies to maintain your session and improve your experience. We do not use tracking cookies for advertising purposes.</p>
            </section>
