        ...
        <div className='p-6 space-y-6'>
          ...
          <div>
            ...
            <p className='text-gray-600 mb-4'>
              {APP_CONFIG.description}. This tool is designed to help TOEFL test
              takers improve their skills through AI-powered feedback and
              practice exercises.
            </p>
            ...
            <div className='bg-gray-50 rounded-lg p-4'>
              ...
              <div className='grid grid-cols-2 gap-4 text-sm mb-3'>
                <div>
                  ...
                  <span className='text-gray-600'>
                    {CREATOR_CONFIG.location}
                  </span>
                </div>
                <div>
                  <span className='font-medium text-gray-700'>Experience:</span>{' '}
                  <span className='text-gray-600'>
                    {CREATOR_CONFIG.experience}
                  </span>
                </div>
              </div>
            ...
            <div className='bg-gray-50 rounded-lg p-4'>
              <div className='grid grid-cols-2 gap-4 text-sm mb-3'>
                <div>
                  ...
                  <span className='text-gray-600'>
                    {CREATOR_CONFIG.project.name}
                  </span>
                </div>
                <div>
                  <span className='font-medium text-gray-700'>Version:</span>{' '}
                  <span className='text-gray-600'>
                    {CREATOR_CONFIG.project.version}
                  </span>
                </div>
              </div>
              <p className='text-gray-600 mb-3'>
                {CREATOR_CONFIG.project.description}
              </p>
